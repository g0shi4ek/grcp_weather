...
func (c *weatherServiceClient) GetWeather(ctx context.Context, in *CityRequest, opts ...grpc.CallOption) (*WeatherData, error) {
...
func (UnimplementedWeatherServiceServer) GetWeather(context.Context, *CityRequest) (*WeatherData, error) {
