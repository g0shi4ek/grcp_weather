...
func (r * WeatherRepo) Create(ctx context.Context, weather * domain.Weather) error{
	query := "INSERT INTO weathers (city, time, temperature, feels_like, humidity, wind_speed) VALUES ($1, $2, $3, $4, $5, $6)"
...
func (r * WeatherRepo) GetByCity(ctx context.Context, city string) ([]*domain.Weather, error){
	...
	query := "SELECT city, time, temperature, feels_like, humidity, wind_speed FROM weather"
